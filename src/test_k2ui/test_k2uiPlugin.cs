...
public class test_k2uiPlugin : BaseSpaceWarpPlugin
{
    ...
    [PublicAPI] public static test_k2uiPlugin Instance { get; set; }

    // AppBar button IDs
    internal const string ToolbarFlightButtonID = "BTN-test_k2uiFlight";
    internal const string ToolbarOabButtonID = "BTN-test_k2uiOAB";
    internal const string ToolbarKscButtonID = "BTN-test_k2uiKSC";
    ...
    public override void OnInitialized()
    {
        ...
        var windowOptions = new WindowOptions
        {
            ...
            WindowId = "test_k2ui_MyFirstWindow",
    ...
    private static void LoadAssemblies()
    {
        ...
        var unityAssembly = Assembly.LoadFrom(Path.Combine(currentFolder, "test_k2ui.Unity.dll"));
